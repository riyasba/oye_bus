                ...
                Column(mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Row(
                            ...
                            ksizedbox20,
                 FormfieldView(  text: 'Riyas', labeltext: 'Name',),
                 FormfieldView(  text: '23', labeltext: 'Age',),
                  FormfieldView(  text: 'Male', labeltext: 'Gender',),
                   FormfieldView(  text: '9633749714', labeltext: 'Mobile Number',),
                    FormfieldView(  text: 'riyasklb89@gmail.com', labeltext: 'Email ID',), ],
                ),ksizedbox40,ksizedbox40,
              Padding(
                                  padding: EdgeInsets.only(
                                    bottom: 10.h,left: 8,right: 8
                                  ),
