                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color:controller.containerindex.value==0? Color(0xffFFC107):Colors.grey.shade200
                          ),
                           child: Center(
                            child: Text('Completed',
                            style: TextStyle(
                              color: controller.containerindex.value==0?Colors.black:kgrey,
                        ...
                        GestureDetector(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(23),
                            color:controller.containerindex.value==1? Color(0xffFFC107):Colors.grey.shade200
                          ),
                          child: Center(
                            child: Text('Cancelled',
                            style: TextStyle(
                              color: controller.containerindex.value==1?Colors.black:kgrey,
                              fontWeight: FontWeight.w500
                            ),),
                          ),
                                    ),
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text('You can rate once you complete thee trip',
                                    style: TextStyle(
