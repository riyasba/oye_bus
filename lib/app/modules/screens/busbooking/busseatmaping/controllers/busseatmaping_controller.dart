...
class BusseatmapingController extends GetxController {
  ...
  List<Seat> getSelectedSeats(BusModel busModel) {
   selectedSeats.clear();
   for (var element in busModel.seatMap) {
  ...
  BusSeatApiService busseatapiservice = BusSeatApiService();
...
// List<BusSeatData> busseatdata=[];
  ...
  List<List<Seat>> generateSeatLayoutLower(BusModel busModel) {
    ...
    List<Seat> rowLower1 =
        sortListPositionsLower(rowNumber: 1, seatList: seatList);
    List<Seat> rowLower2 =
        sortListPositionsLower(rowNumber: 2, seatList: seatList);
    List<Seat> rowLower3 =
        sortListPositionsLower(rowNumber: 3, seatList: seatList);
    List<Seat> rowLower4 =
        sortListPositionsLower(rowNumber: 4, seatList: seatList);
    List<Seat> rowLower5 =
        sortListPositionsLower(rowNumber: 5, seatList: seatList);
    List<Seat> rowLower6 =
        sortListPositionsLower(rowNumber: 6, seatList: seatList);
    List<Seat> rowLower7 =
        sortListPositionsLower(rowNumber: 7, seatList: seatList);
    List<Seat> rowLower8 =
        sortListPositionsLower(rowNumber: 8, seatList: seatList);
    List<Seat> rowLower9 =
        sortListPositionsLower(rowNumber: 9, seatList: seatList);
    List<Seat> rowLower10 =
        sortListPositionsLower(rowNumber: 10, seatList: seatList);
  ...
  List<List<Seat>> generateSeatLayoutUpper(BusModel busModel) {
    ...
    List<Seat> rowUpper1 =
        sortListPositionsUpper(rowNumber: 1, seatList: seatList);
    List<Seat> rowUpper2 =
        sortListPositionsUpper(rowNumber: 2, seatList: seatList);
    List<Seat> rowUpper3 =
        sortListPositionsUpper(rowNumber: 3, seatList: seatList);
    List<Seat> rowUpper4 =
        sortListPositionsUpper(rowNumber: 4, seatList: seatList);
    List<Seat> rowUpper5 =
        sortListPositionsUpper(rowNumber: 5, seatList: seatList);
    List<Seat> rowUpper6 =
        sortListPositionsUpper(rowNumber: 6, seatList: seatList);
    List<Seat> rowUpper7 =
        sortListPositionsUpper(rowNumber: 7, seatList: seatList);
    List<Seat> rowUpper8 =
        sortListPositionsUpper(rowNumber: 8, seatList: seatList);
    List<Seat> rowUpper9 =
        sortListPositionsUpper(rowNumber: 9, seatList: seatList);
    List<Seat> rowUpper10 =
        sortListPositionsUpper(rowNumber: 10, seatList: seatList);
...
// print("Widget list ${_row.length}");
  ...
  List<Seat> sortListPositionsLower(
      {required List<Seat> seatList, required int rowNumber}) {
    List<Seat> rowData = [];

    for (int i = 0; i < seatList.length; i++) {
      if (int.parse(seatList[i].rowNo) == rowNumber &&
          seatList[i].position.trim().toLowerCase() == "lower".toLowerCase()) {
  ...
  List<Seat> sortListPositionsUpper(
      {required List<Seat> seatList, required int rowNumber}) {
    List<Seat> rowData = [];

    for (int i = 0; i < seatList.length; i++) {
      if (int.parse(seatList[i].rowNo) == rowNumber &&
          seatList[i].position.toLowerCase() == "Upper".toLowerCase()) {
        rowData.add(seatList[i]);
      }
    }
