    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: <BoxShadow>[
              BoxShadow(
                  offset: const Offset(0.0, 0.75), blurRadius: 1, color: kgrey)
            ]),
        child: GetBuilder<BusseatmapingController>(builder: (_) {
          return boadingdroppingController.boardingpointdata.isEmpty
              ? const Center(
